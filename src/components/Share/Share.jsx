...
import { useHistory } from 'react-router-dom';
   ...
   async function onShare(shareTarget) {
    ...
    const filesArray = [new File([blob], 'score.jpg', { type: blob.type, lastModified: new Date().getTime() })];
    const shareData = {
        files: filesArray,
    };
...
const shareTarget = useRef()
const history = useHistory()

    return (
        
        <div className="w-full h-screen bg-indigo-500 relative font-Roboto" ref={shareTarget}>
        <div
