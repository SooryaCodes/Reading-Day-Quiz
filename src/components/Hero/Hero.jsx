  ...
  return (
    <div className="w-full block h-auto pb-16 lg:flex mb-10 items-center justify-center ">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-start  lg:pl-10 justify-center relative">
        ...
        <Link to="/profile" className="absolute -right-3 xs:right-0 bottom-5 xs:bottom-0 bg-primary-col font-Mulish text-sm xs:text-base text-white w-20 h-20 xs:w-28 xs:h-28 flex items-center justify-center rounded-full">
